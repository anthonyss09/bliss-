  ...
  return (
    <>
      ...
      <form
        ...
        className={`pb-8 mb-4 mt-0 left-0 absolute duration-500 ease-in-out bg-white flex flex-col z-[60] top-[216px] sm:top-[96px] sm:shadow-xl sm:border-[2px] sm:border-[#3111f310]  ${
          formOpen
